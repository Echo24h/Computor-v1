# computerv1
Computor v1 is a program to solve polynomial equations up to degree 2, showing the reduced form, degree, and solutions.

## Usage

```bash
# With argument
python computorv1 "5 * X^0 + 4 * X^1 - 9.3 * X^2 = 1 * X^0"
...
### Linear equation
```bash
$ python computorv1 "5 * X^0 + 4 * X^1 = 4 * X^0"
...
```bash
$ python computorv1 "1 * X^0 + 2 * X^1 + 5 * X^2 = 0"
...
### Degree > 2
```bash
$ python computorv1 "8 * X^0 - 6 * X^1 + 0 * X^2 - 5.6 * X^3 = 3 * X^0"
...
```bash
# Infinite solutions
$ python computorv1 "6 * X^0 = 6 * X^0"
Reduced form: 0.0 * X^0 = 0
Polynomial degree: 0
Any real number is a solution.

# No solution
$ python computorv1 "10 * X^0 = 15 * X^0"
